...
<title>Сортировка по национальности</title>
</head>
<body>
<h1>Сортировка по национальности</h1>
<?php
require_once 'conn.php';
$nation = $_REQUEST['nk'];
if (!($nation)) {
  echo("Введите национальность студента(-ов)");
}
else
{
...
WHERE nationality.nation_name LIKE '%$nation%'
