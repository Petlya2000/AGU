...
<body>
<h1>Подробные данные о поступающем</h1>
<?php
require_once 'conn.php';
$id = $_REQUEST['nk'];
if (!($id)) {
  echo("Введите номер поступающего");
}
else {
...
if($row) { printf("<p><b>Номер поступающего: ".$row['Ankety_id']."</b></p><p><b>Фамилия : ".$row['Ankety_fam']."</b></p><p><b>Имя : ".$row['Ankety_name1']."</b></p><p><b>Отчество : ".$row['Ankety_otch']."</b></p><p><b>Пол : ".$row['gend_name']."</b></p><p><b>Паспорт: ".$row['document']."</b></p><p><b>Дата рождения: ".$row['date_birth']
...
"</b></p><p><b>Домашний телефон: ".$row['tel_home']."</b></p><p><b>Мобильный телефон: ".$row['tel_mob'].
  "</b></p>----------------------------------------<b>"."</b></p><p><b>Учебное заведение: ".$row['uch_zav_name']."</b></p><p><b>Документ: ".$row['document_educ']."</b></p><p><b>Средний бал: ".$row["srednbal"]
  ."</b></p>----------------------------------------<b>"."</b></p><p><b>Трудовой стаж (1-да, 0 - нет): ".$row['trud_st']."</b></p><p><b>Документ: ".$row['document_trud']
  ."</b></p>----------------------------------------<b>"."</b></p><p><b>Иностранный язык в школе: ".$row['languages_name']."</b></p><p><b>Нужда в общежитии(1-да, 0 -нет): ".$row['LIVING']
  ."</b></p>----------------------------------------<b>"."</b></p><p><b>Документы о льготах (рекомендательные письма): ".$row['vip_letter']."</b></p><p><b>Данные о матери: ".$row['mother']."</b></p><p><b>Данные об отце: ".$row['father']
  ."</b></p>----------------------------------------<b>"); }
